...
/**
 * Class m191231_105535_create_sold_products_per_sale_view
 */
class m191231_105535_create_sold_products_per_sale_view extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->execute("
        CREATE OR REPLACE VIEW `v_sold_products_per_sale`
        AS
        SELECT
            DATE(`date`) AS `day`,
    ...
    {
        echo "m191231_105535_create_sold_products_per_sale_view cannot be reverted.\n";
