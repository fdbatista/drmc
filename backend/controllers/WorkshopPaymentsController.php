...
/**
 * WorkshopPaymentsController implements the CRUD actions for WorkshopPayment model.
 */
class WorkshopPaymentsController extends Controller {
    ...
    public function actionIndex() {
        Yii::$app->view->params['active'] = 'workshop-payments';
