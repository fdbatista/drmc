...
<div class="brand-model-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Agregar Modelo'), ['model-create', 'id' => $searchModel->brand_id], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'template' => '{model-view} {model-update} {model-delete}',
                'buttons' =>
                    [
                    'model-view' => function ($key) {
